...
<head>
    ...
    <style>
        body {
            background: linear-gradient(180deg, rgb(255, 211, 80) 50%, white 50%);
            height: 100vh;
        }
    </style>
...
<body ondblclick="window.location.reload();">
    <div>
        <div class="center">
            <img src="{{ asset('/assets/light.png') }}" style="height: 200px;" alt="">
        </div>
    </div>
    ...
    <div>
        <div class="center" style="margin:60px; display:flex; align-items:center; justify-content:center;">
            <button class="waves-effect btn-large amber darknen-1 black-text" onclick="window.location.reload()"
