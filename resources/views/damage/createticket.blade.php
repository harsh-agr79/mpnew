...
<script type="text/javascript">
    ...
    <form enctype="multipart/form-data" id="createform" action="{{ route($type.'.addtkt') }}" method="post">
        @csrf
        <div class="mp-card" style="margin-top: 20px;">
            <div class="row" style="margin:0; padding: 0;">
                <div class="input-field col s6" style="margin:0; padding: 5px;">
                    <input type="datetime-local" step="any" class="inp browser-default black-text" name="date" value="{{ date('Y-m-d H:i:s') }}"
                        required>
                </div>
                <div class="input-field col s6" style="margin:0; padding: 5px;">
