...
@section('main')
    <div>
        <div class="right">
            <span class="btn amber lighten-1" onclick="$('#addmodal').modal('open')">Add Category</span>
        </div>
        <div class="center">
            <h4>Category List</h4>
        </div>
            ...
            <form id="editcat">
                <div class="row">
                    ...
                    <div class="col s12 center" style="margin-top: 20px;">
                        <button class="btn amber darken-1">Update</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <form id="addcat">
                <div class="row">
                    ...
                    <div class="col s12 center" style="margin-top: 20px;">
                        <button class="btn amber darken-1">ADD</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div id="delmodal" class="modal">
        <div class="modal-content center">
            ...
            <div class="row">
                ...
                <div class="col s6 center">
                    <button class="btn amber darken-1" onclick="$('#delmodal').modal('close')">Cancel</button>
                </div>
            </div>
        </div>
    </div>
