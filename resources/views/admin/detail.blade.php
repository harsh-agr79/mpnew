            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>
                            <label>Status</label><select id="select1" class="browser-default selectinp black-text" {{$dis}} style="width: 90px;">
                ...
                <tbody>
                    ...
                    <input type="hidden" value="{{$item->quantity}}" name="quantity[]">
                        <tr>
                            ...
                            <td>
                                <select name="status[]" class="select2 browser-default selectinp black-text" {{$dis}} style="width: 90px;" required>
